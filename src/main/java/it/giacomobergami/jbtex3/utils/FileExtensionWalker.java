...
import it.giacomobergami.jbtex3.legacy_latex.tex.TexIgnore;
...
public class FileExtensionWalker extends DirectoryWalker<File> {

    public String parentDir;
    private final String suffix;

    public FileExtensionWalker(String fileMainTex, String suffix) {
